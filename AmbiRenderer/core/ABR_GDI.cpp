...
LRESULT CALLBACK HandleMessage(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_SYSKEYDOWN:
    {
        Singleton<ControlManager>::GetInstance()->SetKeyDown(static_cast<unsigned char>(wParam));
        break;
    }
    case WM_KEYUP:
    case WM_SYSKEYUP:
    {
        Singleton<ControlManager>::GetInstance()->SetKeyUp(static_cast<unsigned char>(wParam));
        break;
    }
    case WM_MOUSEMOVE:
    {
    ...
    case WM_LBUTTONDOWN:
    {
        Singleton<ControlManager>::GetInstance()->SetMouseLeft(true);
        break;
    }
    case WM_LBUTTONUP:
    {
        Singleton<ControlManager>::GetInstance()->SetMouseLeft(false);
        break;
    }
    case WM_RBUTTONDOWN:
    {
        Singleton<ControlManager>::GetInstance()->SetMouseRight(true);
        break;
    }
    case WM_RBUTTONUP:
    {
        Singleton<ControlManager>::GetInstance()->SetMouseRight(false);
        break;
    }
