...
__declspec(dllexport) Rasterizer::Rasterizer() noexcept {
	width = 0;
	height = 0;
}

__declspec(dllexport) void Rasterizer::StartUp() noexcept
{
	;
}

__declspec(dllexport) void Rasterizer::SwapBuffer() noexcept
{
	;
}
